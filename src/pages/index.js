...
import { FaGithub, FaMedium, FaTwitterSquare, FaLinkedin, FaBehanceSquare } from 'react-icons/fa';
      ...
      <HeaderStyle>
        ...
        <AboutMeSummary>
          ...
          <div className="description">
            <p className="p-xs">Hi, I love building stuff for the web. I use HTML, CSS, Javascript and PHP together with numerous tools to build for the web.</p>
          ...
          <div className="social-icons">
            ...
            <a href="https://www.behance.net/tadeabiona"><FaBehanceSquare/></a>
          </div>
        </AboutMeSummary>
      </HeaderStyle>
    </div>
